        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <h4 class="header green clearfix">
                    ...
                    <span class="block pull-right">
                        <small class="grey middle">스킨 선택: &nbsp;</small>
            ...
            <form action="update" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="articleSubject" id="articleSubject" value="${article.articleSubject}">
                        <!-- <label for="subject">제목</label> <input type="text" class="form-control" name="boardType" id="boardType" placeholder="Enter title"> -->
                    </div>
                        
                <!-- 중요! wysiwyg-editor 부트스트랩 양식페이지. 실질적으로 입력 데이터는 input으로 들어감(히든형식) -->
                <div class="wysiwyg-editor" id="editor1"></div><!-- 이 한줄로 입력 에디터의 모든 뷰를 보여줌 -->
                
                <input type="hidden" id="hidden-textarea" name="hidden-textarea" value="${article.articleContent}" contenteditable="true" >
                
                <!-- <textarea class="hiddenField" name="editor1Data" id="editor1Data" rows="20" contenteditable="true"></textarea></div> -->
                ...
                <span data-toggle="buttons">
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <button class="btn btn-sm btn-success btn-round" type="submit" id="form" onclick=""><!-- publish -->
...
<![endif]-->
    ...
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery.ui.touch-punch.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery.hotkeys.index.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/bootstrap-wysiwyg.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/resources/assets/js/bootbox.js"></script>
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $('textarea[data-provide="markdown"]').each(function() {
                ...
                $this.parent().find('.btn').addClass('btn-round'); // addClass('btn-white')
            })
    ...
    */
            ...
            $('[data-toggle="buttons"] .btn').on('click', function(e) {
                ...
                if (which >= 1 && which <= 4) {
                    ...
                    else if (which == 2) $(toolbar).addClass('wysiwyg-style2'); // 이라인 불필요할듯?
                    if (which == 4) {
                        $(toolbar).find('.btn-group > .btn').addClass('btn-white btn-round'); // 'btn-round'로도 문제없는듯?
                    } else $(toolbar).find('.btn-group > .btn-white').removeClass('btn-white btn-round'); 
                }
            });

            
            // 이 코드 중요!! 잘 돌아가는가는 불확실ㅋㅋ 
            $('#form').submit(function() {
                $('#hidden-textarea').val($('#editor1').html())
            });
            ...
            $('#editor1').html($('#hidden-textarea').val());
            */
