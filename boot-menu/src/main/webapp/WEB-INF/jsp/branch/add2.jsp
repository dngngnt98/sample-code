								...
								<form class="form-horizontal" role="form" action="add.do" method="post" enctype="multipart/form-data">
									...
									<div class="row">
											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														<div class="form-group">
															<div class="col-xs-12">
																<input type="file" name="photo" id="id-input-file-2" onchange="loadFile(event)">
															</div>
														</div>
										...
										<div class="col-xs-12 col-sm-6">
											 ...
											 <div class="image fit">
												 <img class="img-thumbnail" id="output" alt="store image" items="${branch.photoList}" var="path" /> 
												</div>
