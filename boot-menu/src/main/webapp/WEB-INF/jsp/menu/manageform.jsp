												...
												<c:choose>
													<c:when test="${item.deleteCheck eq 'N'}">
														<tr>
															...
															<td class="hidden-480">${item.mno}</td>
															<td class="hidden-480">${item.mtype}</td>
															<td>${item.mdate}</td>
															<td>
																			...
																			<form>
																				<fieldset>
																					<textarea class="width-100" resize="none"
																						name="manageContent"
																						placeholder="${item.mcontent}"></textarea>
																				</fieldset>
