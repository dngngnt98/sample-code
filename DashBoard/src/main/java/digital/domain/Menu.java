...
public class Menu extends Admin {
	...
	public String toString() {
		return "Menu [menuNo=" + menuNo + ", menuType=" + menuType + ", menuName=" + menuName + ", menuPrice="
				+ menuPrice + ", menuManager=" + menuManager + ", menuContent=" + menuContent + ", menuKcal=" + menuKcal
				+ ", menuDate=" + menuDate + ", menuUdate=" + menuUdate + ", deleteCheck=" + deleteCheck
				+ ", imageInfo=" + imageInfo + "]";
	}
