							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="insert" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> 분류 </label>

										<div class="col-sm-9">
											<input type="text" name="menuType" id="form-field-1-1"class="col-xs-10 col-sm-6" />
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-2"> 메뉴이름 </label>

										<div class="col-sm-9">
											<input type="text" name="menuName" id="form-field-1-2" class="col-xs-10 col-sm-6" />
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-3"> 메뉴가격 </label>

										<div class="col-sm-9">
											<input type="text" name="menuPrice" id="form-field-1-3" class="col-xs-10 col-sm-6" />
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-4"> 열량 </label>

										<div class="col-sm-9">
											<input type="text" name="menuKcal" id="form-field-1-4" class="col-xs-10 col-sm-6" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-icon-1"> 메뉴 설명 </label>

										<div class="col-sm-9">
											<span class="input-icon">
											<input type="text" name="menuContent" id="form-field-icon-1"  />
