...
<!-- ace styles -->
<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/assets/css/ace.min.css"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="boardInfo" id="form-field-2"
										 placeholder="게시판 설명" class="col-xs-10 col-sm-6" />
									</div>
								</div>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													<div class="form-group">
														<div class="col-xs-12">
															<textarea name="manageContent" style="resize: none" rows="6" cols="72"></textarea>
														</div>
													</div>
												</div>
											</div>
