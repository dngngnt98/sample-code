		...
		<div class="main-content">
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<!-- 타이틀과 매장 추가버튼 -->
					<div class="row">
						<span class="col-xs-9"><div class="table-header">게시판 상세정보</div></span> <span class="col-xs-3">
							<button class="btn btn-white btn-primary btn-bold">
								<i class="ace-icon fa fa-cloud-upload hidden-480"></i><a href='form.html'>게시판 추가</a>
							</button>
						</span>
					</div>
					<!-- table을 위한 바깥 div 시작 -->
								...
								<div class="col-xs-12">
									...
									<table id="simple-table"
										...
										<tbody id="store-tbody">
											<c:forEach items="${curBoard}" var="item">
												<!-- 객체 전체에 걸쳐 반복 실행? /c:forEach까지 -->
												<c:choose>
													<c:when test="${item.deleteCheck eq 'N'}">
														<tr>
															<td class="center"><label class="pos-rel"> <input type="checkbox" class="ace" id="checkbox1"
															...
															<td>
																<div class="hidden-sm hidden-xs btn-group">
																	...
																	<script type="text/javascript">
																	   function edit(){
																		   location.href="../board/detail?${item.boardManageNo}"
																	   }
																	</script>
