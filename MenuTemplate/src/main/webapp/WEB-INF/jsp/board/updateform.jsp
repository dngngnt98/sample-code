...
<link href="${pageContext.servletContext.contextPath}/resources/assets/css/summernote.css" rel="stylesheet">
...
<body class="subpage">
								...
								<tbody>
										...
										<td>
											<div class="form-group">
												<label for="subject"><strong>제목 입력</strong></label> <input
													...
													id="boardTitle" placeholder="Enter title">
									...
									<tr>
										<td>
											<div class="form-group">
												<label for="File">
													<button class="replace">파일 업로드</button> <input type="file"
													id="File" value="파일업로드" class="upload">
												</label>
											</div>
										</td>
									</tr>
	...
	<script src="${pageContext.servletContext.contextPath}/resources/assets/js/summernote.js"></script>
	<script src="${pageContext.servletContext.contextPath}/resources/assets/lang/summernote-ko-KR.js"></script>
	<script>
		$(function() {
			// jQuery활용 데이터 보내보기
