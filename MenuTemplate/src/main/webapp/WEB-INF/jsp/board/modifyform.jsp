...
<body class="no-skin">
							...
							<form class="form-horizontal" role="form" action="update"
								...
								<div class="form-group">
									<label Hidden="true"
										...
										for="form-field-1"> 번호 </label>

									<div class="col-sm-9">
										<input type="hidden" name="boardManageNo" id="form-field-1"
											value="${curBoard.boardManageNo}" placeholder="번호"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="boardType" id="form-field-1-1"
											value="${curBoard.boarType}" placeholder="타입"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="boardManager" id="form-field-1-2"
											value="${curBoard.boardManager}" placeholder="관리자"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="createDate" id="form-field-1-3"
											value="${curBoard.createDate}" placeholder="작성일"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="updateDate" id="form-field-1-4"
											value="${curBoard.updateDate}" placeholder="수정일"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-2"> 게시판 설명 </label>

									<div class="col-sm-9">
										<input type="text" name="boardInfo" id="form-field-2"
											value="${curBoard.boardInfo}" placeholder="게시판 설명"
											class="col-xs-10" />
									</div>
								</div>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													<div class="form-group">
														<div class="col-xs-12">
															<textarea name="manageContent" style="resize: none"
																rows="6" cols="72">
															${curBoard.manageContent}
															</textarea>
														</div>
													</div>
												</div>
								...
								<div class="clearfix form-actions">
									<div class="col-md-offset-3 col-md-9">
										<button class="btn btn-info" id="active" type="button">
										...
										&nbsp; &nbsp;
										<button class="btn btn-danger" type="button" id="doDelete">
											<i class="ace-icon fa fa-exclamation-circle bigger-110"></i>
											삭제
										</button>

										&nbsp; &nbsp;
										<button class="btn btn-success" type="button" id="doList">
	...
	<script type="text/javascript">
		$(function() {
		    // 삭제			
			$(#doDelete).click(functiion(){
				location.href="../board/delete?boardManageNo=${curBoard.boardManageNo}";
			})
            // 작성
			$(#active).click(functiion(){
                location.href="../board/write";
            })
            // 게시판 관리 페이지 이동
            $(#doList).click(functiion(){
                location.href="../board/manage";
            })
			/* 이 함수는 이이디 체크 함수 같은데 아마 맨위 상단 헤더의 아이디 부분에 관련 있는 거 같다 
			   잘 한번 써먹어 보자
			*/
