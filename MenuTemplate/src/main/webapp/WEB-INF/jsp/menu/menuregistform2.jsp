			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							메뉴 정보 <small> <i
								class="ace-icon fa fa-angle-double-right"></i> 메뉴 정보 입력
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" action="insert" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="menuType" id="form-field-1-1"
											placeholder=" 분류" class="col-xs-10 col-sm-6" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="menuName" id="form-field-1-2"
											placeholder=" 메뉴이름 " class="col-xs-10 col-sm-6" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="menuPrice" id="form-field-1-3"
											placeholder="메뉴가격" class="col-xs-10 col-sm-6" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="menuKcal" id="form-field-1-4"
											placeholder="열량" class="col-xs-10 col-sm-6" />
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-2"> 메뉴 설명 </label>

									<div class="col-sm-9">
										<input type="text" name="menuContent" id="form-field-2"
											placeholder="메뉴 설명" class="col-xs-10 col-sm-6" />
									</div>
								</div>
                    ...
                    <p id="status">File API & FileReader API not supported</p>
										<div class="image fit" id="image area">
											<img class="img-thumbnail" id="output" alt="menu image" />
										</div>
								...
								<script type="text/javascript">
				                  var upload = document.getElementById('id-input-file-2'),
				                    holder = document.getElementById('image area'),
