...
<title>템플릿에 메뉴 등록</title>
        ...
        <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/${pageContext.servletContext.contextPath}/resources/assets/css/bootstrap.min.css" />
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="menuPrice" for="menuPrice"> 가격</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="menuCal" for="menuCal"> 열량</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="form-field-first" for="menuDivision"> 메뉴분류?</label>
...
<![endif]-->
        ...
        <!--[if lte IE 8]>
          <script src="${pageContext.servletContext.contextPath}/resources/assets/js/excanvas.min.js"></script>
        <![endif]-->
        <script src="${pageContext.servletContext.contextPath}/resources/${pageContext.servletContext.contextPath}/resources/assets/js/jquery-ui.custom.min.js"></script>
